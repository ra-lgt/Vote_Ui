...
document.getElementById("layout-menu") && (isHorizontalLayout = document.getElementById("layout-menu").classList.contains("menu-horizontal")),
    function() {
        ...
        var s, l = localStorage.getItem("templateCustomizer-" + templateName + "--Style") || (window.templateCustomizer ?.settings ?.defaultStyle ?? "light"),
            i = (window.templateCustomizer && t && ([].slice.call(t.children[1].querySelectorAll(".dropdown-item")).forEach(function(e) {
            ...
            }), i = t.querySelector("i"), "light" === l ? (i.classList.add("bx-sun"), new bootstrap.Tooltip(i, {
                title: "Light Mode",
                fallbackPlacements: ["bottom"]
            })) : "dark" === l ? (i.classList.add("bx-moon"), new bootstrap.Tooltip(i, {
                title: "Dark Mode",
                fallbackPlacements: ["bottom"]
            })) : (i.classList.add("bx-desktop"), new bootstrap.Tooltip(i, {
                title: "System Mode",
                fallbackPlacements: ["bottom"]
            }))), "system" === (s = l) && (s = window.matchMedia("(prefers-color-scheme: dark)").matches ? "dark" : "light"), [].slice.call(document.querySelectorAll("[data-app-" + s + "-img]")).map(function(e) {
